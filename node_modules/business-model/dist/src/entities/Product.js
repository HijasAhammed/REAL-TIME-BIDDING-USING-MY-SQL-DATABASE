...
exports.createProductCollection = exports.productsCollection = void 0;
const serverless_mongodb_utils_1 = require("serverless-mongodb-utils");
exports.productsCollection = 'products';
const createProductCollection = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield database.createCollection(exports.productsCollection, options);
    }
    catch (error) {
